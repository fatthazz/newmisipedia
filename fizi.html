...
<section class="profile" id="misi-characters">
    <h2>Fizi</h2>
    <img src="image/fizi.png" alt="Fizi"> <!-- Replace with the character image URL -->

    <div class="detail-item">
        <strong>Nama Penuh:</strong>
        <span class="detail-text">Hafizi bin Ismail</span>
    </div>
	 <div class="detail-item">
        <strong>Misi:</strong>
        <span class="detail-text">Angkasawan</span>
    </div>
    <div class="detail-item">
        <strong>Kemahiran:</strong>
        <span class="detail-text">Fizik</span>
    </div>
    <div class="detail-item">
        <strong>Perilaku:</strong>
        <span class="detail-text">Kuat makan, suka mengumpul koleksi replika</span>
    </div>
    <div class="detail-item">
        <strong>Penampilan:</strong>
        <span class="detail-text">Juara futsal. Jerawat remaja semasa zaman sekolah.</span>
    </div>
    <div class="detail-item">
        <strong>Sekilas:</strong>
        <span class="detail-text">Fizi adalah satu-satunya watak yang don't judge Fizi by it's physical ekoran meskipun mempunyai badan yang berlebihan tetapi Fizi mengaplikasikan semua ilmu fizik dalam pelbagai sukan</span>
    </div>
</section>
