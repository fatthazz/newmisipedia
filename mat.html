...
<section class="profile" id="misi-characters">
    <h2>Mat</h2>
    <img src="image/mat.png" alt="Mat"> <!-- Replace with the character image URL -->

    <div class="detail-item">
        <strong>Nama Penuh:</strong>
        <span class="detail-text">Mat</span>
    </div>
	 <div class="detail-item">
        <strong>Misi:</strong>
        <span class="detail-text">Ahli Matematik</span>
    </div>
    <div class="detail-item">
        <strong>Kemahiran:</strong>
        <span class="detail-text">Matematik</span>
    </div>
    <div class="detail-item">
        <strong>Perilaku:</strong>
        <span class="detail-text">Seorang yang pendiam, hanya bercakap apabila perlu. Sering tertidur dan hanya bersemangat apabila mengira</span>
    </div>
    <div class="detail-item">
        <strong>Penampilan:</strong>
        <span class="detail-text">Gaya rambut serabai. Baju tidak dituck in. Mata eyebag</span>
    </div>
    <div class="detail-item">
        <strong>Sekilas:</strong>
        <span class="detail-text">Mat adalah watak prodigi Matematik yang kurang didedahkan seperti watak lain</span>
    </div>
</section>
